...
description: >
  Executes an implementation plan with fresh-context subagents and
...
digraph process {
    ...
    "Dispatch final code reviewer subagent for entire implementation" -> "Use superpowers-brain:finishing-a-development-branch";
}
```
...
- **superpowers-brain:requesting-code-review** - Code review template for reviewer subagents
- **superpowers-brain:finishing-a-development-branch** - Complete development after all tasks

**Subagents should use:**
- **superpowers-brain:test-driven-development** - Subagents follow TDD for each task

**Alternative workflow:**
- **superpowers-brain:executing-plans** - Use for parallel session instead of same-session execution
